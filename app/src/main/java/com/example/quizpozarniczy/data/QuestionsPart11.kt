...
val questionsPart11 = listOf(
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Tak, pod warunkiem zastosowania blachy aluminiowej",
            "Tak, pod warunkiem zastosowania blachy stalowej ocynkowanej nie cieńszej niż 0,5 mm"
        ),
        correctIndex = 2
    ),
    ...
    Question(
        ...
        answers = listOf(
            "Respirator",
            "Worek samorozprężalny, rezerwuar tlenu i przewód łączący",
            "Komplet masek twarzowych połączonych z respiratorem"
        ),
        correctIndex = 1
    ),

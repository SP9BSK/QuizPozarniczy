...
val questionsPart9 = listOf(
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Zbiornik na wodę o pojemności 2500 l i działko o wydajności 250 l/min",
            "Zbiornik na środek pianotwórczy o pojemności 250 l i działko o wydajności 1600 l/min"
        ),
        correctIndex = 2
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Sprzęt oświetleniowy, sprzęt pływający i nurkowy",
            "Sprzęt alpinistyczny, dźwigi samochodowe"
        ),
        correctIndex = 0
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Kołowy lub gąsienicowy pojazd mechaniczny przystosowany do poruszania się w czasie akcji ekologicznych"
        ),
        correctIndex = 0
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Tak, jeżeli występuje wentylacja mechaniczna i pozytywna opinia KM/PSP",
    ...
    Question(
        ...
        answers = listOf(
            ...
            "14 dni przed rozpoczęciem kontroli",
            "Nie ma określonego terminu zawiadamiania"
        ),
        correctIndex = 2
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Tylko obiekty zagrożone wybuchem"
        ),
        correctIndex = 1
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Ustawia samochód i uruchamia autopompę"
        ),
        correctIndex = 2
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Wilgotność drzew i poszycia gleby",

...
val questionsPart15 = listOf(
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Sprzęt pożarniczy pianowy służący do zasysania i dozowania środka pianotwórczego przy wytwarzaniu piany ciężkiej za pomocą prądownicy PP-8-12",
            "Sprzęt pożarniczy pianowy służący do zasysania i dozowania środka pianotwórczego przy wytwarzaniu piany ciężkiej za pomocą prądownicy PP-200"
        ),
        correctIndex = 0
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Urządzenie sejsmiczno-akustyczne do wykrywania i lokalizowania zasypanych ludzi",
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Zamknąć drzwiami o odporności ogniowej 30 minut",
            "Wykonać przedsionek z drzwiami o odporności ogniowej 30 minut"
        ),
        correctIndex = 1
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Muszą być wykonane z materiałów trudno zapalnych",
            "Muszą posiadać odporność ogniową nie mniejszą niż dach"
        ),
        correctIndex = 0
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Taką samą odporność ogniową jak ściana",
            "Muszą spełniać wyłącznie warunek dymoszczelności"
        ),
        correctIndex = 1
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Przeznaczonego dla więcej niż 50 osób, z wyjątkiem zabytków",
            "Z każdego budynku użyteczności publicznej"
        ),
        correctIndex = 1
    ),

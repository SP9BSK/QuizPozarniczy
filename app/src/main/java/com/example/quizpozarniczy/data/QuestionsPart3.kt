...
val questionsPart3 = listOf(
    ...
    Question(
        ...
        answers = listOf(
            ...
            "20–40 cm poniżej lustra wody",
            "15–20 cm poniżej lustra wody"
        ),
        correctIndex = 2
    ),
    ...
    Question(
        ...
        answers = listOf(
            ...
            "Linia wężowa od punktu czerpania wody do nasady ssawnej pompy",
            "Linia wężowa od nasady hydrantu do nasady ssawnej pompy lub bezpośrednio do zbiornika wodnego samochodu gaśniczego"
        ),
        correctIndex = 2
    ),
    ...
    Question(
        ...
        answers = listOf(
            "Środek gaśniczy",
            "Materiał z którego wykonuje się ubrania strażackie",
            "Środek ogniochronny"
        ),
        correctIndex = 1
    )
